...
def get_re_en():
    ...
    while True:
        try:
            ...
            dicts[f'{ticket_no}'] = f'{name}'
            dicts_en[f'{ticket_no}'] = f'{resp_en.text}'
            # 解密
            ...
            dicts_re[f'{ticket_no}'] = f'{resp_re.text}'
...
if __name__ == '__main__':
    f = open(r'E:\文件\data\FaradayFile\TLA\TLA_USED2019-08-11TRAVELSKY.txt', encoding='utf-8')
    lines = f.readlines()
    q = queue.Queue()
